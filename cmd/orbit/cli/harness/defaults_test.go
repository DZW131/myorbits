...
func TestRuntimeManifestConversionPreservesInstallSourceKinds(t *testing.T) {
	...
	runtimeFile := RuntimeFile{
		...
		Members: []RuntimeMember{
			...
			{OrbitID: "qa", Source: MemberSourceInstallBundle, AddedAt: time.Date(2026, time.April, 9, 10, 10, 0, 0, time.UTC)},
	...
	require.Equal(t, []ManifestMember{
		{OrbitID: "docs", Source: ManifestMemberSourceInstallOrbit, AddedAt: time.Date(2026, time.April, 9, 10, 5, 0, 0, time.UTC)},
		{OrbitID: "qa", Source: ManifestMemberSourceInstallBundle, AddedAt: time.Date(2026, time.April, 9, 10, 10, 0, 0, time.UTC)},
		{OrbitID: "cli", Source: ManifestMemberSourceManual, AddedAt: time.Date(2026, time.April, 9, 10, 15, 0, 0, time.UTC)},
